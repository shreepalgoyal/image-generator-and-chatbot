// Code for ChatBot Google Free API
...
// API setup
const API_KEY = "Your Google Studio API Key Here";
...
//DallE Image Genration using paid OpenAI API
...
const handleImageGeneration = (e) => {
  ...
  const imgCardMarkup = Array.from({ length: userImgQuantity }, () => 
      `<div class="img-card loading">
        <img src="images/img-loader.svg" alt="AI generated image">
        <a class="download-btn" href="#">
          <img src="images/img-download.svg" alt="download icon">
        </a>
      </div>`
  ).join("");
